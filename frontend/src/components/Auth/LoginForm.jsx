      ...
      <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 md:p-10 shadow-xl max-w-md w-full">
        ...
        <form className="space-y-6" onSubmit={handleSubmit} noValidate>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <a href="/recuperar" className="text-sm text-green-600 hover:text-green-800 font-medium whitespace-nowrap">
        ...
        <div className="mt-8">
          ...
          <div className="mt-6">
            <div className={`rounded-xl p-[2px] bg-google-border transition-all hover:animate-google-border hover:shadow-lg ${isLoading || !isAccepted ? 'opacity-50 cursor-not-allowed' : ''}`}>
              <button onClick={handleGoogleLogin}
                type="button"
                disabled={isLoading}
                title={!isAccepted ? "Acepta las cookies para iniciar sesión con Google" : ""}
                className="flex w-full items-center justify-center gap-2 py-3 px-4 rounded-[10px] bg-google-base text-gray-700 hover:bg-google-hover font-medium"
              >
