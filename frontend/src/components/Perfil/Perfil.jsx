...
export default function ProfileEcoIt() {
    ...
    useEffect(() => {
        const cargarPerfil = async () => {
            if (usuario) {
                // Si ya tenemos usuario en el contexto, usamos esos datos como base
                setUserData({
            ...
            // Opcional: obtener datos frescos del backend
            /*
            try {
    ...
    const handleEdit = () => {
        // La navegación se maneja con el Link/a href
    };

    const handleLogout = () => {
        logout();
        // Redirección debería manejarse globalmente o aquí si es necesario
                    ...
                    >
                        ...
                        <div className="pt-20 pb-8 px-6 md:px-8">
                            ...
                            >
                                ...
                                {/* Botón editar */}
                                <Link to="/editarperfil" className="w-full">
                                    <motion.div
